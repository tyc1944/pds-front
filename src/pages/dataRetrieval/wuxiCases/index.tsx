                ...
                <BoxContainerInner flex={1} noPadding noBorder>
                    <Tabs defaultActiveKey="1" onChange={this.onTabChange}>
                        <TabPane tab={<TableNameWithNumber name="检查文书" count={0} />} key="1">
                            <ProcuratorialDocument onDetailClick={this.onDetailClick}></ProcuratorialDocument>
                        </TabPane>
                        <TabPane tab={<TableNameWithNumber name="法院文书" count={0} />} key="2">
                            <CourtDocument onDetailClick={this.onDetailClick}></CourtDocument>
                        </TabPane>
                        <TabPane tab={<TableNameWithNumber name="行政案件" count={0} />} key="3">
                            <AdministrativeCase onDetailClick={this.onDetailClick}></AdministrativeCase>
                        </TabPane>
                        <TabPane tab={<TableNameWithNumber name="执行案件" count={0} />} key="4">
                            <EnforcementCase onDetailClick={this.onDetailClick}></EnforcementCase>
                        </TabPane>
                    </Tabs>
                </BoxContainerInner>
            </BoxContainer>
