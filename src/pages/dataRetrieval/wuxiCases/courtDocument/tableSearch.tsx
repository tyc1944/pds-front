...
export const TableSearch = (props: {
    ...
    >
        <div className="table-search-container" style={{
            ...
            <div>
                <Row>
                    <Col xl={2} xs={4} style={{ color: '#9099A2' }}>审理法院</Col>
                    <Col xl={22} xs={20}>
                        <SingleSelectionGroup name="courtName" defaultValue="不限"
                            selectItems={["不限", "市中级人民法院", "滨湖区人民法院", "惠山区人民法院",
                                "锡山区人民法院", "新吴区人民法院", "江阴市人民法院", "宜兴市人民法院"]}></SingleSelectionGroup>
                    </Col>
                </Row>
            </div>
            <div>
                <Row>
                    ...
                    <Col xl={22} xs={20}>
                        <SingleSelectionGroup name="category" defaultValue="不限"
                            selectItems={["不限", "民事案件", "刑事案件"]}></SingleSelectionGroup>
                    </Col>
                </Row>
            </div>
        </div>
