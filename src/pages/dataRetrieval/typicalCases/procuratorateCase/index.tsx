...
interface ProcuratorateCaseProps {
    data?: DataStore
...
@inject("data")
@observer
class ProcuratorateCase extends React.Component<ProcuratorateCaseProps> {
            ...
            <BoxContainer noPadding>
                <BoxContainerInner>
                    <TableSearch onSearch={changed => {
                        this.getWikiTypicalCases(fillObjectFromOpsValue({ category: '检察' }, changed))
                    }}></TableSearch>
                </BoxContainerInner>
...
export default ProcuratorateCase;