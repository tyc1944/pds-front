        ...
        >
            ...
            >
                    ...
                    <Row>
                        <Col span="12">
                            <Form.Item
                                ...
                                { pattern: /^[a-zA-Z0-9]{6,16}$/, message: "请输入6到16位数字与字母组合" }]}
                            >
                ...
                <Form.Item {...tailLayout}>
                    ...
                    >
                        <ColorButton htmlType="submit" bgColor="#4084F0">确认新增</ColorButton>
                        <ColorButton
                            bgColor="#FFFFFF"
                            fontColor="#1E1E1E"
        ...
        >
            ...
            >
                ...
                <Form.Item {...tailLayout}>
                    ...
                    >
                        <ColorButton htmlType="submit" bgColor="#4084F0">确认保存</ColorButton>
                        <ColorButton
                            bgColor="#FFFFFF"
                            fontColor="#1E1E1E"
                            onClick={props.onCancel}
