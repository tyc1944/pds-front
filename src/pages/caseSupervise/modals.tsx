  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Col span={12}>案件编号：{props.superviseData.id}</Col>
          <Col span={12}>
            报案时间：{formatTimeYMD(props.superviseData.relatedDate)}
          </Col>
        </Row>
        <Row
          style={{
        ...
        >
          <Col span={24}>案件类别：{props.superviseData.exceptionResult}</Col>
        </Row>
        {/* <Row style={{
                    margin: "0px 0 17px 0"
                }}>
                    <Col span={24}>案件名称：{props.superviseData}</Col>
                </Row> */}
      </div>
      <div
        style={{
