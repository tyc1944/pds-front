...
class DepartmentLeaderPendingAppointCaseSupervise extends React.Component<CaseSuperviseProps> {
...
export default DepartmentLeaderPendingAppointCaseSupervise;