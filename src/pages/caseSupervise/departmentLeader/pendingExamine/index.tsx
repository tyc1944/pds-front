...
class DepartmentLeaderPendingExamineCaseSupervise extends React.Component<CaseSuperviseProps> {
...
export default DepartmentLeaderPendingExamineCaseSupervise;